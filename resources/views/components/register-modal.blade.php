                ...
                <form id="register-form" class="space-y-4">
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" id="reg-first-name" placeholder="John" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all" required>
                        </div>
                        <div>
                            <label for="reg-last-name" class="block text-sm font-medium text-gray-700 mb-1.5">Last Name</label>
                            <input type="text" id="reg-last-name" placeholder="Doe" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all" required>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="reg-email" placeholder="you@example.com" class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all" required>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" id="reg-phone" placeholder="+91 98765 43210" class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all" required>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="reg-password" placeholder="Min. 8 characters" class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all" required>
                        </div>
                    </div>
                    <div class="flex items-start gap-2">
                        <input type="checkbox" id="reg-terms" class="w-4 h-4 mt-0.5 rounded border-gray-300 text-primary-500 focus:ring-primary-500/20" required>
