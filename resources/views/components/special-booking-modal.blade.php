        ...
        <div class="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl overflow-hidden animate-fade-in-up my-auto">
            ...
            <div class="p-8 sm:p-10">
                ...
                <div class="text-center mb-8">
                    <div id="special-modal-icon-bg" class="w-14 h-14 bg-gradient-to-br from-red-500 to-rose-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-red-500/20 transition-colors duration-300">
                ...
                <!-- Form -->
                <form id="special-booking-form" class="space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="sb-name" class="block text-sm font-medium text-gray-700 mb-1.5">Patient Name</label>
                            <input type="text" id="sb-name" placeholder="Full Name" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all" required>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" id="sb-whatsapp" placeholder="+91 98765 43210" class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all" required>
                        </div>
                    </div>

                    <div>
                        <label for="sb-reason" class="block text-sm font-medium text-gray-700 mb-1.5">Brief Description of Issue</label>
                        <textarea id="sb-reason" rows="3" placeholder="Please describe the symptoms or reason for the booking..." class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-all resize-none" required></textarea>
                    </div>

                    <button type="submit" id="sb-submit-btn" class="w-full py-3.5 bg-gradient-to-r from-red-500 to-rose-600 text-white font-semibold rounded-xl hover:from-red-600 hover:to-rose-700 shadow-lg shadow-red-500/20 transition-all hover:shadow-xl hover:-translate-y-0.5 cursor-pointer mt-4">
                        Confirm Booking
                    </button>
                </form>
                ...
                <div id="sb-success" class="hidden text-center py-6">
                    ...
                    <button type="button" class="px-8 py-3.5 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold rounded-xl shadow-lg shadow-primary-500/20 transition-all hover:shadow-xl" data-close-modal="special-booking-modal">
                        Done
                    </button>
                </div>
            </div>
