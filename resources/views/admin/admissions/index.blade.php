...
@section('title', 'OPD / IPD')
@section('content')
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">OPD / IPD Management</h1>
            <p class="text-sm text-gray-500 mt-1">Manage patient admissions and discharges</p>
        </div>
