    ...
    <nav class="admin-tab-nav">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="hidden lg:flex items-center tab-scroll overflow-x-auto" style="scrollbar-width: none; -ms-overflow-style: none;">
                ...
                <a href="{{ route('admin.lab-bookings.index') }}" class="admin-tab {{ $isActiveTab('admin.lab-bookings.*') ? 'active' : '' }}">Lab Bookings</a>
                <a href="{{ route('admin.health-package-bookings.index') }}" class="admin-tab {{ $isActiveTab('admin.health-package-bookings.*') ? 'active' : '' }}">Health Packages</a>
            ...
            <div class="lg:hidden py-2">
                ...
                <div id="mobile-tab-menu" class="hidden mt-2 bg-linear-to-b from-white to-slate-50 rounded-xl border border-slate-200 shadow-lg p-2 space-y-1">
                    ...
                    <a href="{{ route('admin.lab-bookings.index') }}" class="block px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-150 {{ $isActiveTab('admin.lab-bookings.*') ? 'bg-blue-50 text-blue-700 ring-1 ring-blue-200' : 'text-slate-700 hover:bg-blue-50 hover:text-blue-700' }}">Lab Bookings</a>
                    <a href="{{ route('admin.health-package-bookings.index') }}" class="block px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-150 {{ $isActiveTab('admin.health-package-bookings.*') ? 'bg-blue-50 text-blue-700 ring-1 ring-blue-200' : 'text-slate-700 hover:bg-blue-50 hover:text-blue-700' }}">Health Packages</a>
