...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $sidebarItems = [
            ['label' => 'Overview', 'href' => '#overview', 'icon' => 'M3 13h18M3 6h18M3 20h18'],
            ['label' => 'Appointments', 'href' => '#appointments', 'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
            ['label' => 'Patients', 'href' => '#patients', 'icon' => 'M12 12a5 5 0 100-10 5 5 0 000 10zm6 8v-2a6 6 0 00-12 0v2'],
            ['label' => 'Consultations', 'href' => '#consultations', 'icon' => 'M7.5 8.25h9m-9 4.5h9m-9 4.5H12M9.75 3h4.5c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 1.125 0 018.625 6.375v-2.25C8.625 3.504 9.129 3 9.75 3z'],
            ['label' => 'Prescriptions', 'href' => '#prescriptions', 'icon' => 'M12 20.25c4.97 0 9-4.03 9-9s-4.03-9-9-9-9 4.03-9 9 4.03 9 9 9z'],
            ['label' => 'Labs & EMR', 'href' => '#labs', 'icon' => 'M6 3v18m12-18v18M6 6h12M6 18h12'],
            ['label' => 'Schedule', 'href' => '#schedule', 'icon' => 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5'],
            ['label' => 'Notifications', 'href' => '#notifications', 'icon' => 'M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31'],
            ['label' => 'Reports', 'href' => '#reports', 'icon' => 'M3 3v18h18M7 14l3-3 4 4 5-7'],
            ['label' => 'Profile', 'href' => '#profile', 'icon' => 'M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0'],
        ];
